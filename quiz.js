...
export const QUIZ = [
  { q: "What is the primary structural component of every Hike insole?", difficulty: "easy", options: ["The top cover","The 3D-printed base","The cork base","The wedge slab"], answer: 1, correct: "Correct!", wrong: "Not quite.", explanation: "The base of the insole is the 3D-printed structural foundation. The top cover is glued on top of it. A shell is only Hike Shell — 3/4 length. Everyday, Sport, Flexible Shell, UCBL, and the Sweets are bases, not shells." },
  ...
  { q: "What is the key build rule for a Morton's Extension that must never be violated?", difficulty: "hard", options: ["The extension must always taper thin toward the tip","The base edge must stay full thickness all the way to the tip — no taper","The extension must cover all five rays","The extension must be glued separately after printing"], answer: 1, correct: "Exactly right — this is critical!", wrong: "Not quite — thinning the edge defeats the entire accommodation.", explanation: "The base edge under a Morton's Extension must stay full thickness to the tip. If thinned or tapered, the rigid lever arm disappears and the whole accommodation stops working." },
  ...
  { q: "Both medial and lateral flanges together on the same device creates what?", difficulty: "medium", options: ["A Charcot device","The defining geometry of a UCBL","A Hike Flexible Shell","Hike Shell"], answer: 1, correct: "Correct!", wrong: "Not quite — medial and lateral flanges together defines the UCBL geometry.", explanation: "Both medial and lateral flanges running simultaneously is the defining geometry of a UCBL — the tall walls on both sides fully enclosing the rearfoot." },
