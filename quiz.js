...
export const QUIZ = [
  ...
  { q: "Hike Sport and Hike Everyday are structurally:", difficulty: "easy", options: ["Completely different shells with different geometry","The same shell — the name is a labeling convenience","Different durometer versions of the same shell","Sport is slimmer; Everyday is wider"], answer: 1, correct: "Correct!", wrong: "Not quite — they are the same shell with different labels.", explanation: "Hike Sport and Hike Everyday are the same shell — same geometry, same print. The name difference is a labeling convenience for order context, not a structural difference." },
  ...
  { q: "Which correctly describes Met Head Offload vs Drill and Fill?", difficulty: "hard", options: ["Both remove contact entirely at the met head","Offload removes contact entirely via a well and plug; Drill and Fill softens the zone with a material swap — no recess","Drill and Fill removes contact; Offload softens the zone","They are identical — just different names"], answer: 1, correct: "Perfect — that's the critical distinction!", wrong: "Not quite — offload removes contact via a well; Drill and Fill softens without a recess.", explanation: "Met Head Offload cuts a well into the shell with a soft plug — the head never contacts the insole. Drill and Fill prints the same zone in soft material flush with the surface — pressure redistributed, not removed. Mutually exclusive on any given head." },
];
