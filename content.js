  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        camera: "relief",
        steps: [
          { camera: "relief", legend: "Met Head Offload", pair: [{ po: "OFFLOAD-MET-HEAD", side: "LEFT" }], text: "<p>An {{offload}} does not cushion \u2014 it removes contact entirely. The <b>Met Head Offload</b> cuts a precise oval well into the insole bed directly beneath a targeted metatarsal head so that when the patient bears weight, that head never touches the insole surface. The tissue floats above the well. No contact, no pressure, no damage. This is why offloads are most common on diabetic devices \u2014 a patient with {{neuropathy}} cannot feel a pressure point building until it has already become a wound. The offload removes that risk before it starts.</p><p>MT2 through MT4 positions are calculated automatically from the patient's foot geometry. MT1 and MT5 are selectable independently. Default depth is 4 mm, capped to always leave a structural floor above the shell base. The well does not stay empty \u2014 a soft plug printed to the exact shape of the well fills it flush with the surrounding surface. The patient feels nothing unusual through the top cover, but the targeted head floats above the plug zone with every step while the surrounding heads take the load normally. On any given head, Met Head Offload is mutually exclusive with Drill and Fill \u2014 one approach per head, never both.</p><p>In QC, verify the well is at the correct head position before anything else. The plug must sit perfectly flush \u2014 proud means a new pressure point, recessed means the head may still make partial contact. Check depth is consistent across the full oval. Once the top cover is glued, the well is no longer visible or measurable \u2014 QC is the last checkpoint before that window closes. For asymmetric prescriptions, verify each foot independently against its own Rx marking. Do not assume both feet have the same offload targets.</p>" },
        ],
      },
      {
        id: "offload-plug",
