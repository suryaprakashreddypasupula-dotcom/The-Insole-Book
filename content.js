...
export const GLOSSARY = {
  ...
  "intrinsic / extrinsic": "Two ways to build a wedge. Extrinsic: a separate printed TPU slab under a flat, untilted base \u2014 the angle lives on the slab. Intrinsic: the tilt is baked into the base itself, so there is no separate part.",
  "sulcus": "The groove just behind the toes, where they join the forefoot. Designers use the sulcus line as the front cutting boundary for top covers and base extensions.",
  ...
  "heel post": "A platform built onto the underside of the base under the heel. Four shapes, one per device: Oval (the usual even correction), Flat (height without tilt), U (center of the heel unloaded), and Stabilizer (the widest, most controlling base).",
  "Kirby Skive": "A steep medial heel bias printed into the base \u2014 aggressive pronation control at first contact, more abrupt than a standard medial rearfoot post. No separate wedge part.",
  ...
  "thickness boost": "The base prints thicker than standard across the whole plate. No angle, no directional correction \u2014 just more material, so the device is heavier and more rigid.",
  ...
  "ray cutout": "A bite taken out of a base's front edge. 1st ray = a round medial bite behind MT1. 5th ray = a straight oblique cut on the lateral front edge. Independent of each other; mutually exclusive with a gait plate.",
    ...
    lessons: [
      {
        ...
        /* the product film: every device the paragraphs name, in the order
           they are named, ending on the cover lifting off the printed base */
        film: [
    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          ...
          { camera: "overview", cover: "T1", legend: "T1 \u00b7 1/8\u2033 P-Cell \u00b7 3.2 mm \u00b7 1 layer", text: "<p><b>T1</b> is the foundational diabetic cover \u2014 a single full layer of {{P-Cell}} foam at 1/8\u2033 thickness. There is nothing underneath it. The foot touches P-Cell, and P-Cell sits directly on the base. It is the simplest recipe in the Sweet family and it is paired with the {{Sweet}} base at 35 durometer \u2014 the softest base Hike makes.</p><p>A patient who needs a Diabetic 35 base is in the highest-risk category \u2014 neuropathy, fragile skin, pressure wounds, or extreme sensitivity. Their foot cannot afford friction, hot spots, or hard contact with a base surface. P-Cell provides a forgiving, friction-reducing cushion between the foot and the base. One layer, no complexity, maximum gentleness. On the floor T1 is a single-layer profile and a uniform soft foam surface \u2014 no visible color split at the edge, no layering, just clean P-Cell from surface to base.</p>" },
          { camera: "overview", cover: "T2", legend: "T2 \u00b7 1/16\u2033 P-Cell over 1/16\u2033 Poron \u00b7 3.2 mm \u00b7 2 layers", text: "<p><b>T2</b> is the same finished thickness as T1 \u2014 3.2 mm \u2014 but it achieves that thickness with two layers instead of one. The top layer is 1/16\u2033 {{P-Cell}}, which is what the foot touches. The bottom layer is 1/16\u2033 {{Poron}}, which sits between the P-Cell and the base. The Poron never contacts the skin. It is a shock layer \u2014 its job is to absorb and disperse the impact energy that travels through the foot with every step before it reaches the base.</p><p>T2 is paired with the {{Double Sweet}} base at 45 durometer. The patient still needs diabetic skin protection, but they are at a slightly lower risk level than a Sweet patient, or they need some biomechanical support in addition to pressure protection. P-Cell handles the skin interface. Poron handles the impact. At the edge you will see two distinct layers \u2014 a thin lighter P-Cell on top and a slightly denser Poron below. That visible split is your quick identification in QC.</p>" },
          { camera: "overview", cover: "T3", legend: "T3 \u00b7 1/8\u2033 P-Cell over 1/16\u2033 Poron \u00b7 4.8 mm \u00b7 2 layers", text: "<p><b>T3</b> is the thickest cover in the Sweet family and the thickest diabetic cover in the library at approximately 4.8 mm. Same two-material logic as T2 \u2014 {{P-Cell}} on top, {{Poron}} underneath \u2014 but the P-Cell is now a full 1/8\u2033 instead of 1/16\u2033. That thicker P-Cell gives the foot significantly more cushioning depth at the skin interface.</p><p>T3 is paired with the {{Triple Sweet}} base at 55 durometer. A Triple Sweet patient typically has a heavier body weight or a need for more rigid correction alongside diabetic protection. The T3 cover compensates for that firmer base by adding more cushioning depth above it. On the floor T3 is the easiest Sweet cover to identify: noticeably thicker than T1 or T2, and at the edge two distinct colors \u2014 a thick P-Cell layer on top and Poron beneath. That two-color edge should be clean and consistent all the way around the perimeter.</p>" },
