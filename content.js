...
export const CHAPTERS = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          {
            text: "<p>At Hike, every custom insole starts with an order \u2014 but not all orders are the same. A Consumer Order is placed directly by the consumer through the Hike platform. There is no clinician involved in the design decisions. Instead, our system and design team use the foot scan data to determine the right arch sizing, shape, and support for that person. It is a streamlined, self-serve experience \u2014 fast and accessible \u2014 designed to get a great custom insole.</p><p>A Clinical Order is submitted by a licensed clinician \u2014 a podiatrist, orthotist, or other qualified provider \u2014 who has evaluated the patient in person. The clinician owns the prescription and specifies exactly what they need: the orthotic type, the top cover length (full, sulcus, or shell), and any accommodations. Those specifications go straight into the design. Our team builds exactly what the clinician ordered, for that patient's clinical need.</p><p>The distinction between these two order flows matters for everyone at Hike, because it shapes what gets built, how it gets built, and what standard it is held to. A consumer order follows a consistent, design-team-driven template. A clinical order follows the clinician's prescription \u2014 and our job is to execute it precisely, every single time, with zero room for interpretation errors. Both flows end at the same place: a finished, 3D-printed custom insole shipped out of our facility within five business days. But understanding where an order comes from tells you everything about what went into it \u2014 and what the patient on the other end is counting on. \ud83e\uddb6</p><p>Within about five minutes of a first order, Hike texts to confirm and offers a quick call to review before building starts. If the clinician is with a patient, they reply and Hike picks a time. Every order includes a <b>Your Order Specs</b> card that documents every feature built into the device. Once delivered, Hike checks that the fit is right. If a device does not fit or perform as expected, a free remake is the path \u2014 not guessing in the clinic.</p><p><b>How a clinician orders on the platform \u2014 seven steps.</b></p><ol class=\"ol-plain\"><li><b>Select Products to Begin</b> \u2014 Custom Inserts, Toe Filler, Therapeutic Shoes, or Pre-Fabricated Inserts.</li><li><b>Enter Shoe Size and Width.</b></li><li><b>Select Insert Type</b> \u2014 Functional or Diabetic.</li><li><b>Enter Product Specs</b> \u2014 shell length and top cover length.</li><li><b>Add Modifications</b> \u2014 accommodations, additions, and extensions.</li><li><b>Add Additional Notes</b> \u2014 Base and Goal / Diagnosis and Location / Modification and Function / Dimensions. The more specific the notes, the more precisely Hike can build the device. \u201cOffload the 2nd met-head ulcer\u201d is better than \u201cadd a met pad.\u201d</li><li><b>Review Your Order</b> \u2014 confirm everything is accurate, then submit. Additional products can be added here.</li></ol><p><b>Two support channels.</b></p><table class=\"facts\"><tr><th>In-App Support</th><td>A real human on the manufacturing floor who knows the account and can answer questions about modifications and how the device is built.</td></tr><tr><th>Account Manager</th><td>The go-to for questions about the account, ordering, or anything to be added to the catalog.</td></tr></table>",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    lessons: [
        ...
        steps: [
          {
            ...
            text: "<p>When it comes to diabetic insoles, everything starts with one critical question: how much protection does this patient's foot need? Diabetic patients \u2014 especially those with {{neuropathy}}, poor circulation, or a history of ulcers \u2014 cannot feel pressure building up under their feet the way a healthy patient can. That means a shoe that feels fine to them could be causing serious damage without any warning. This is why the Sweet family exists. Every diabetic base we print is engineered first and foremost around pressure relief and skin protection, and the {{durometer}} \u2014 the firmness of the shell \u2014 is the primary clinical dial a clinician turns to match the insole to the patient's risk level.</p><p>There are three stock PDAC-approved diabetic inserts in this family: {{Sweet}}, {{Double Sweet}}, and {{Triple Sweet}}. Non-Medicare orders that need a thinner forefoot than these presets use {{BYO}} \u2014 that is the next lesson.</p><p>The softest of the three is the {{Sweet}} (Diabetic 35). At 35 durometer EVA, this is the gentlest shell we produce \u2014 almost cloud-like underfoot. It is designed for the highest-risk diabetic feet: patients with active {{neuropathy}}, fragile skin, open wounds, or extreme pressure sensitivity. The lower the durometer, the more the shell gives and distributes load across a wider surface area rather than concentrating it at high-pressure points. Paired with a T1 top cover \u2014 a single layer of 1/8\u2033 {{P-Cell}} foam \u2014 the foot rests on a soft, friction-reducing surface that is kind to even the most vulnerable skin.</p><div class=\"spec\"><i><b>Shell</b><span>35 durometer EVA</span></i><i><b>Heel cup</b><span>Standard 10 mm</span></i><i><b>Weight</b><span>Up to 200 lbs</span></i><i><b>Forefoot</b><span>Preset 4.725 mm</span></i><i><b>Top cover</b><span>1/8\u2033 P-Cell (T1)</span></i></div>",
          },
          {
            camera: "heelProfile",
            cover: "T2",
            pair: [{ po: "PAIR-TOP-COVER", side: "LEFT" }],
            text: "<p>Step up to the {{Double Sweet}} (Diabetic 45) and you get a shell that balances protection with structure. At 45 durometer EVA it is firmer than the Sweet, offering more biomechanical support while still providing the cushioning a diabetic foot needs. This is the most commonly prescribed middle-ground diabetic shell \u2014 suited for patients who need protection but also benefit from some correction or stability. Its paired top cover is T2: 1/16\u2033 {{Poron}} and 1/16\u2033 {{P-Cell}}. P-Cell is what the foot touches. Poron sits underneath as the shock absorber. Same finished thickness as T1 at 3.2 mm, but doing two jobs at once \u2014 skin protection and impact absorption.</p><div class=\"spec\"><i><b>Shell</b><span>45 durometer EVA</span></i><i><b>Heel cup</b><span>Standard 10 mm</span></i><i><b>Weight</b><span>200 to 295 lbs</span></i><i><b>Forefoot</b><span>Preset 4.725 mm</span></i><i><b>Top cover</b><span>1/16\u2033 Poron + 1/16\u2033 P-Cell (T2)</span></i></div>",
          },
          {
            camera: "heelProfile",
            cover: "T3",
            pair: [{ po: "PAIR-TOP-COVER", side: "LEFT" }],
            text: "<p>At the top of the Sweet family sits the {{Triple Sweet}} (Diabetic 55). The shell is 55 durometer cork \u2014 the firmest stock diabetic base we make \u2014 used for heavier patients, or cases where a clinician needs more rigid correction alongside the diabetic protection. Its T3 top cover is the thickest in the Sweet family at nearly 5 mm \u2014 a full 1/8\u2033 of {{P-Cell}} on top of a 1/16\u2033 {{Poron}} shock layer underneath. When you finish a Triple Sweet on the wheel, you can actually see the two distinct layers at the edge \u2014 two visible colors where the stacked materials meet. That visual is your quick confirmation on the floor that you are looking at a T3 build.</p><div class=\"spec\"><i><b>Shell</b><span>55 durometer cork</span></i><i><b>Heel cup</b><span>Standard 10 mm</span></i><i><b>Weight</b><span>295 lbs and above</span></i><i><b>Forefoot</b><span>Preset 3.175 mm</span></i><i><b>Top cover</b><span>1/16\u2033 Poron + 1/8\u2033 P-Cell (T3)</span></i></div>",
          },
        ],
      },
      {
        id: "byo-diabetic",
        title: "BYO Diabetic \u2014 Build Your Own",
        layout: "info",
        steps: [
          {
            text: "<p>Select <b>Build Your Own</b> for non-Medicare orders that need a thinner forefoot than the stock PDAC-approved Sweets. The Sweet, Double Sweet, and Triple Sweet keep their published presets. {{BYO}} is the dial when those presets are too thick, too long, or the wrong taper for the shoe.</p><p>Platform path: <b>Insert Type \u2192 Diabetic \u2192 Diabetic Insert Type \u2192 Build Your Own \u2192 Base</b>. The base is 35 or 45 durometer EVA. Durometer and forefoot thickness / \u00be-length are set there.</p><table class=\"facts\"><tr><th>Options</th><td>Thinner forefoot, gradual forefoot taper, \u00be-length, or a sulcus base with a full-length top cover</td></tr><tr><th>\u00be-length base</th><td>0.8 mm base with a full-length top cover</td></tr><tr><th>Stock PDAC presets</th><td>Sweet 35 and Double Sweet 45 = 4.725 mm forefoot. Triple Sweet 55 = 3.175 mm forefoot</td></tr></table><p>If the order is Medicare and the stock Sweet matches the need, stay on the stock SKU. BYO is the exception path, not the default.</p>",
          },
        ],
      },
      {
      ...
      {
        id: "traditional-lab",
        title: "Coming from a Traditional Lab",
        layout: "info",
        steps: [
          {
            text: "<p>Clinicians who come from a traditional lab will look for glued foam, second-color posts, and Poron they can carve. Hike prints those jobs into the base. Same clinical intent. Different build. This table is the translation.</p><table class=\"facts\"><tr><th>You say / expect</th><th>What Hike does</th><th>Why it is as good or better</th></tr><tr><td>Co-poly functional shell</td><td>Hike Sport / Everyday (co-poly function), or Hike Shell for a thin co-poly look</td><td>Same flex and support; more consistent build</td></tr><tr><td>Poron top layer, then carve/scoop offloads and drill-and-fills</td><td>Soft surface printed directly into the base</td><td>Exact, durable depth and shape \u2014 Poron degrades and loses shape</td></tr><tr><td>Met / Arch / Heel / Dancer pads glued in</td><td>Printed into the base with multi-density printing</td><td>Integrated, will not shift or peel; can be felt under the top cover</td></tr><tr><td>Extrinsic wedge / posting in a second color, glued on</td><td>Printed from identical material intrinsically on the base</td><td>Uniform color, no seam, one continuous piece</td></tr><tr><td>Thermal cork base</td><td>Hike cork-mimic base, can be modified like cork</td><td>Function and performance of thermal cork</td></tr></table><p><b>Rigidity reference.</b></p><table class=\"facts\"><tr><th>Material</th><th>Feel and best for</th></tr><tr><td>Co-poly functional shell</td><td>Flexible with cushion and rebound; good arch support for everyday wear</td></tr><tr><td>Poly-Pro \u2014 rigid</td><td>Very rigid, true arch support, no give. Firm-control cases such as plantar fasciitis that need a hard device</td></tr></table><p>Hike uses a thinner shell for a more flexible feel and builds the shell thicker for firmer control. The trade-off is a thicker device, especially through the forefoot.</p>",
          },
        ],
      },
      {
        id: "clinic-limits",
        title: "Clinic Adjustment Limits",
        layout: "info",
        steps: [
          {
            text: "<div class=\"callout\"><b>Safety note</b>Diabetic EVA shells can be adjusted in the clinic by up to about 2 mm. Cork-mimic shells can be adjusted slightly deeper than 2 mm. Never use a heat gun on any Hike device. Never place a Hike device in an oven. If something is not right, a free remake is the correct path \u2014 not in-clinic modification.</div><p>That is the whole rule. The printed geometry is the prescription. Heat, ovens, and aggressive grinding change a device Hike already stands behind. If the fit or the function is off, send it back through the remake path.</p>",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          {
            text: "<div class=\"faq\"><b>This doesn't look like what my lab sends.</b><p>That is intentional. Features are built directly into the 3D-printed device for consistent, precise results. The Order Specs card shows exactly what was built into the device.</p></div><div class=\"faq\"><b>Where is the Poron for my offloads?</b><p>Hike prints a soft Poron-like interface rather than creating a relief and adding Poron. The printed interface keeps its material properties over time \u2014 Poron degrades with repeated wear.</p></div><div class=\"faq\"><b>Why is the wedge the same color as the base?</b><p>Extrinsic wedges are printed from the same material as the base as one continuous piece. There is no seam or second material.</p></div><div class=\"faq\"><b>I cannot see the met pad you built in.</b><p>Some modifications are printed directly into the base and covered by the top cover, so they are not visible from the outside. You can feel them through the top cover. The Order Specs card identifies exactly what was built in.</p></div><div class=\"faq\"><b>Can you match a traditional polypropylene device?</b><p>The printing process replicates the functional properties of polypropylene, providing comparable firm control.</p></div><div class=\"faq\"><b>Can I get it thinner or \u00be-length?</b><p>Yes. Hike offers standard thickness, a thinning taper, and \u00be-length options. For \u00be-length, the base is 0.8 mm with a full-length top cover.</p></div><div class=\"faq\"><b>Can I adjust it in the clinic?</b><p>You should not need to \u2014 free remakes are available if something is not right. If an adjustment is necessary, diabetic EVA can be adjusted up to about 2 mm and cork-mimic can be adjusted slightly deeper. Never use a heat gun or place the device in an oven.</p></div><div class=\"faq\"><b>How fast will I get it?</b><p>Devices are manufactured and shipped within 5 business days.</p></div>",
          },
        ],
      },
    ],
