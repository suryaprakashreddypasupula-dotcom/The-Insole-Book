  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        id: "drill-fill",
        title: "Drill & Fill",
        models: [{ po: "PAIR-DRILL-FILL-1ST", side: "LEFT" }],
        camera: "relief",
        steps: [
          { camera: "relief", text: "<p><b>Drill & Fill</b> is the softer alternative to the Met Head Offload on the same oval footprint, same heads, same selection \u2014 but no bed recess and no bump. This mesh is the 1st met head. The zone is its own add-on STL; the density slicer prints it soft, typically {{P-Cell}} or {{Poron}}, while the shell around it prints standard. From above the surface looks flush. Underneath, the soft zone compresses more easily and pushes pressure outward. It redistributes pressure. It does <b>not</b> remove contact.</p>" },
          { camera: "forefoot", anim: "press", text: "<p>Load it. The soft fill compresses while the firm base holds. For a patient who needs relief at a met head but does not have an open wound or ulcer, this is the graduated answer. Active wounds and high-risk tissue still want the full well-and-plug offload. Mutually exclusive with the Met Head Offload on any given head. Under the 1st \u2014 the hardest-striking point of the forefoot \u2014 that plunge is what saves the tissue.</p>" },
          { camera: "relief", anim: "release", text: "<p>Unloaded, it springs back flush. Nothing to feel, nothing to catch a sock on. QC: press it. It must compress more than the adjacent shell. If it feels the same hardness, the material swap did not process.</p>" },
        ],
      },
      {
        id: "heel-offload",
